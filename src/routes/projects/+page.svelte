<script>
	...
	import ProjectMapviewer from './projectSections/projectMapviewer.svelte';
	import ProjectCapstone from './projectSections/projectCapstone.svelte';
	import ProjectFEWD from './projectSections/projectFEWD.svelte';
</script>
